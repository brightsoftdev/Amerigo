...
//    _GTMDevAssert(cell.index != self.activeGap,                   @"Found cell with index %d!", cell.index);
  }
}
...
//  _GTMDevAssert(![self.viewCells containsObject:pannedCell],                 @"Panned cell should no longer be visible");
}
