...
+ (NSString *)stringForErrorCode:(AudioStreamerErrorCode)anErrorCode
{
	...
	{
		case AS_NO_ERROR:
			return NSLocalizedString(@"AS_NO_ERROR_STRING", @"");
		case AS_FILE_STREAM_GET_PROPERTY_FAILED:
			return NSLocalizedString(@"AS_FILE_STREAM_GET_PROPERTY_FAILED_STRING", @"");
		case AS_FILE_STREAM_SEEK_FAILED:
			return NSLocalizedString(@"AS_FILE_STREAM_SEEK_FAILED_STRING", @"");
		case AS_FILE_STREAM_PARSE_BYTES_FAILED:
			return NSLocalizedString(@"AS_FILE_STREAM_PARSE_BYTES_FAILED_STRING", @"");
		case AS_AUDIO_QUEUE_CREATION_FAILED:
			return NSLocalizedString(@"AS_AUDIO_QUEUE_CREATION_FAILED_STRING", @"");
		case AS_AUDIO_QUEUE_BUFFER_ALLOCATION_FAILED:
			return NSLocalizedString(@"AS_AUDIO_QUEUE_BUFFER_ALLOCATION_FAILED_STRING", @"");
		case AS_AUDIO_QUEUE_ENQUEUE_FAILED:
			return NSLocalizedString(@"AS_AUDIO_QUEUE_ENQUEUE_FAILED_STRING", @"");
		case AS_AUDIO_QUEUE_ADD_LISTENER_FAILED:
			return NSLocalizedString(@"AS_AUDIO_QUEUE_ADD_LISTENER_FAILED_STRING", @"");
		case AS_AUDIO_QUEUE_REMOVE_LISTENER_FAILED:
			return NSLocalizedString(@"AS_AUDIO_QUEUE_REMOVE_LISTENER_FAILED_STRING", @"");
		case AS_AUDIO_QUEUE_START_FAILED:
			return NSLocalizedString(@"AS_AUDIO_QUEUE_START_FAILED_STRING", @"");
		case AS_AUDIO_QUEUE_BUFFER_MISMATCH:
			return NSLocalizedString(@"AS_AUDIO_QUEUE_BUFFER_MISMATCH_STRING", @"");
		case AS_FILE_STREAM_OPEN_FAILED:
			return NSLocalizedString(@"AS_FILE_STREAM_OPEN_FAILED_STRING", @"");
		case AS_FILE_STREAM_CLOSE_FAILED:
			return NSLocalizedString(@"AS_FILE_STREAM_CLOSE_FAILED_STRING", @"");
		case AS_AUDIO_QUEUE_DISPOSE_FAILED:
			return NSLocalizedString(@"AS_AUDIO_QUEUE_DISPOSE_FAILED_STRING", @"");
		case AS_AUDIO_QUEUE_PAUSE_FAILED:
			return NSLocalizedString(@"AS_AUDIO_QUEUE_DISPOSE_FAILED_STRING", @"");
		case AS_AUDIO_QUEUE_FLUSH_FAILED:
			return NSLocalizedString(@"AS_AUDIO_QUEUE_FLUSH_FAILED_STRING", @"");
		case AS_AUDIO_DATA_NOT_FOUND:
			return NSLocalizedString(@"AS_AUDIO_DATA_NOT_FOUND_STRING", @"");
		case AS_GET_AUDIO_TIME_FAILED:
			return NSLocalizedString(@"AS_GET_AUDIO_TIME_FAILED_STRING", @"");
		case AS_NETWORK_CONNECTION_FAILED:
			return NSLocalizedString(@"AS_NETWORK_CONNECTION_FAILED_STRING", @"");
		case AS_AUDIO_QUEUE_STOP_FAILED:
			return NSLocalizedString(@"AS_AUDIO_QUEUE_STOP_FAILED_STRING", @"");
		case AS_AUDIO_STREAMER_FAILED:
			return NSLocalizedString(@"AS_AUDIO_STREAMER_FAILED_STRING", @"");
		case AS_AUDIO_BUFFER_TOO_SMALL:
			return NSLocalizedString(@"AS_AUDIO_BUFFER_TOO_SMALL_STRING", @"");
		default:
			return NSLocalizedString(@"AS_AUDIO_STREAMER_FAILED_STRING", @"");
	}
...
#ifdef TARGET_OS_IPHONE			
		//use iToast to display error message
		NSString* errMsg = NSLocalizedStringFromTable([AudioStreamer stringForErrorCode:self.errorCode], @"Errors", nil);
